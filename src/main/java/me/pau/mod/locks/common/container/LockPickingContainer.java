package me.pau.mod.locks.common.container;
...
import me.pau.mod.locks.common.init.LocksDamageSources;
...
public class LockPickingContainer extends AbstractContainerMenu {
	...
	protected float getPinDifficulty(int index) {
		// Basically takes the distance (how many pins away) between the clicked pin and the next correct pin, then divides that by the amount of pins left to click and then plugs it into a simple linear function -ax+a where a = 0.4
