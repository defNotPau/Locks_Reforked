...
public class Lockable extends Observable implements Observer {
	public static class State {
		...
		public boolean inView(Frustum ch) {
			return ch.isVisible(new AABB(this.bb.minX, this.bb.minY, this.bb.minZ, this.bb.maxX, this.bb.maxY, this.bb.maxZ));
		}
		...
		public boolean inRange(Vec3 pos) {
			...
			double max = mc.options.getEffectiveRenderDistance() * 8;
			return dist < max * max;
		}
	}
